...
Rocketchip can be run on private, local data on your computer or on public, remote data downloaded via the Internet. We will run Rocketchip first with local data and then remote data. Create a new directory, possibly in your home directory for testing. We will do all of our testing in this directory. Once complete, you can remove it.
