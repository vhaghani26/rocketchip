...
int GenomeGetConservedSeg_Main(int argv, char **argc)
{
	...
	strcpy(strGenomePath, "/data/genomes/mouse/mm6/");
	strcpy(strCSPath, "/data/genomes/mouse/mm6/conservation/genomelab/cs/");
	strcpy(strCDSPath, "/data/genomes/mouse/mm6/cds/");
