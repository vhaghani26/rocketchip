...
int menu_getseqcsfromgenome(int argv, char **argc)
{
	...
	else if(argv == 1)
	{
		...
		printf(" example: \n");
		printf("    genome_getseqcs -d /data/genomes/human/b35_hg17/ -c /data/genomes/human/b35_hg17/conservation/phastcons/ -s human -i /data/genomes/human/b35_hg17/testid.txt -o ./ -a testseq -r genebase -f txt\n");
		printf("/* ----------------------------- */\n");
		exit(EXIT_SUCCESS);
	}
