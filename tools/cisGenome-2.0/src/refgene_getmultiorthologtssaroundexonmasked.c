...
int menu_refgene_getmultiorthologtssaroundexonmasked(int argv, char **argc)
{
	...
	{
		printf("/* ----------------------------- */\n");
		printf(" refgene_getmultiorthologtssaroundexonmasked\n");
		...
		printf(" example: \n");
		printf("    refgene_getmultiorthologtssaroundexonmasked -i testortho.msomap -up -5000 -down 1000 -d genomesetting.txt -o ./ -a testortho\n");
		printf("/* ----------------------------- */\n");
		exit(EXIT_SUCCESS);
	}
